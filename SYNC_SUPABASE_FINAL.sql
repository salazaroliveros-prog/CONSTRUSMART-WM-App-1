...
-- ============================================================
-- PASO 20: CREAR POLÍTICAS RLS — renglones
-- ============================================================
...
-- ============================================================
-- PASO 21: CREAR POLÍTICAS RLS — renglon_usage
-- ============================================================
...
-- ============================================================
-- PASO 22: CREAR POLÍTICAS RLS — renglon_precios_historial
-- (no tiene user_id propio; se autentica vía renglones → user_id)
-- ============================================================
...
-- ============================================================
-- PASO 23: CREAR POLÍTICAS RLS — cambios_presupuesto
-- ============================================================
...
-- ============================================================
-- PASO 24: CREAR POLÍTICAS RLS — materiales_proyecto
-- ============================================================
...
-- ============================================================
-- PASO 25: CREAR POLÍTICAS RLS — movimientos_materiales
-- ============================================================
...
-- ============================================================
-- PASO 26: CREAR POLÍTICAS RLS — conciliaciones
-- ============================================================
...
-- ============================================================
-- PASO 27: CREAR POLÍTICAS RLS — partidas_conciliacion
-- ============================================================
...
-- ============================================================
-- PASO 28: CREAR POLÍTICAS RLS — checklist_items
-- ============================================================
...
-- ============================================================
-- PASO 29: CREAR POLÍTICAS RLS — notificaciones
-- ============================================================
...
-- 31c. Columnas clave (incluye costo_directo y columnas nuevas)
...
-- 31d. Conteo de tablas sincronizadas
...
-- =====================================================================
-- FIN — 31a debe mostrar ✅ RLS ON en las 17 tablas
-- =====================================================================
