-- =====================================================================
-- FIX_ALL_SUB_POLICIES.sql
-- Script único para todas las políticas faltantes
-- =====================================================================

-- subrenglon_materiales
...
SELECT 'All policies created successfully';