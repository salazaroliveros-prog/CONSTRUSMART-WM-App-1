...
-- 2. FUNCIÓN DE SEGURIDAD (rompe recursión RLS en equipos/equipo_miembros)
...
-- 4. TABLAS DEL SISTEMA (orden de creación respeta dependencias)
...
-- 4.10. renglones (catálogo de APU — análisis de precios unitarios)
...
-- 4.11. renglon_usage (historial de uso de renglones en presupuestos)
...
-- 4.12. renglon_precios_historial (historial de precios de renglones)
...
-- 4.13. cambios_presupuesto (control de cambios / change orders)
...
-- 4.14. materiales_proyecto (materiales asignados a cada presupuesto)
...
-- 4.15. movimientos_materiales (entradas/salidas de materiales)
...
-- 4.16. conciliaciones (conciliaciones bancarias)
...
-- 4.17. partidas_conciliacion (partidas individuales de conciliación)
...
-- 4.18. checklist_items (checklist de calidad por fase)
...
-- 4.19. notificaciones (notificaciones del sistema)
