  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 px-4 pb-4 pointer-events-none">
      <div className="max-w-md mx-auto pointer-events-auto">
        {!isOnline ? (
          <div className="flex items-center gap-2 bg-amber-500 dark:bg-amber-600 text-white px-4 py-2.5 rounded-xl shadow-lg border border-amber-400 text-xs font-semibold animate-slide-in">
          ...
          <div className="flex items-center gap-2 bg-emerald-500 dark:bg-emerald-600 text-white px-4 py-2.5 rounded-xl shadow-lg border border-emerald-400 text-xs font-semibold animate-slide-in">
